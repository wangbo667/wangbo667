...
if ($request.url.match(/\/kd.youth.cn\/v5\/nameless\/adlickstart/)) {
...
function lookStart(timeout = 0) {
    return new Promise((resolve) => {
        let url = {
            url : 'https://kd.youth.cn/v5/nameless/adlickstart.json',
...
function lookstart(timeout = 0) {
    return new Promise((resolve) => {
        let url = {
            url : 'https://kd.youth.cn/v5/nameless/bannerstatus.json',
            headers : lookheader,
            body : zqlookStartbody1,}//xsgbody,}
        $.post(url, async (err, resp, data) => {
            try {
...
function reward(timeout = 0) {
    return new Promise((resolve) => {
        let url = {
            url : 'https://kd.youth.cn/v5/nameless/adlickend.json',
